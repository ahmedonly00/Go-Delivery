...
public class BranchController {
    ...
    @Operation(summary = "Create a new branch", description = "Create a basic branch with essential information")
    ...
    @Operation(summary = "Update branch details", description = "Update branch information including logo")
    ...
    @Operation(summary = "Get all branches for a restaurant", description = "Retrieve all branches belonging to a specific restaurant")
