...
public class BikerService {
    ...
    public BikerRegistrationResponse registerBiker(BikerRegistrationRequest request) {
        ...
        // Send welcome email/notification (uncomment when NotificationService is
        // implemented)
    ...
    public void broadcastOrderToAvailableBikers(Order order) {
        ...
        String restaurantName = order.getRestaurant() != null ? order.getRestaurant().getRestaurantName()
                : "Restaurant";
    ...
    public NavigationResponse getNavigation(NavigationRequest request) {
        ...
        if ("RESTAURANT".equals(request.getNavigationType()) ||
            ...
            destinationAddress = order.getBranch() != null ? order.getBranch().getAddress() : "Restaurant location";
    ...
    public DeliveryTrackingResponse getDeliveryTracking(Long orderId) {
        ...
        if (order.getBikers() != null) {
            ...
            response.setCurrentLatitude(
                    biker.getCurrentLatitude() != null ? biker.getCurrentLatitude().doubleValue() : null);
            response.setCurrentLongitude(
                    biker.getCurrentLongitude() != null ? biker.getCurrentLongitude().doubleValue() : null);
        }
        ...
        if (order.getOrderPlacedAt() != null) {
            history.add(new DeliveryTrackingResponse.DeliveryStatusHistory(
                    "PLACED", order.getOrderPlacedAt(), null, "Order placed by customer", null, null));
        }
        if (order.getOrderConfirmedAt() != null) {
            history.add(new DeliveryTrackingResponse.DeliveryStatusHistory(
                    "CONFIRMED", order.getOrderConfirmedAt().atStartOfDay(), null, "Restaurant confirmed order", null,
                    null));
        }
        ...
        if (order.getDeliveredAt() != null) {
            history.add(new DeliveryTrackingResponse.DeliveryStatusHistory(
                    "DELIVERED", order.getDeliveredAt().atStartOfDay(), null, "Order delivered to customer", null,
                    null));
    ...
    public DeliveryConfirmationResponse confirmDelivery(DeliveryConfirmationRequest request) {
        ...
        if (order.getOrderStatus() != OrderStatus.PICKED_UP) {
            throw new IllegalStateException(
                    "Order is not ready for delivery confirmation. Current status: " + order.getOrderStatus());
        }
        ...
        DeliveryConfirmationResponse.DeliveryEarnings earnings = DeliveryConfirmationResponse.DeliveryEarnings.builder()
