...
public class MenuItemService {
    ...
    @Transactional
    public MenuItemResponse createMenuItem(MenuItemRequest request, String imageUrl) {
    ...
    @Transactional
    public MenuItemResponse updateMenuItem(Long menuItemId, UpdateMenuItemRequest request, String imageUrl) {
        ...
        try {
            ...
            if (menuItems.isEmpty()) {
                throw new ResourceNotFoundException(
                        "No menu items found for your restaurant. Please add some menu items to get started.");
            }
