...
public class RestaurantMapper {
    ...
    // Convert Restaurant to RestaurantDTO with all branches
    ...
    public BranchesDTO toBranchDTO(Branches branch) {
        ...
        return BranchesDTO.builder()
                ...
                .operatingHours(branch.getOperatingHours() != null ? branch.getOperatingHours().toString() : null)
                .setupStatus(branch.getSetupStatus())
    ...
    public BranchUsers toBranchUser(BranchUserDTO branchUserDTO) {
        ...
        return BranchUsers.builder()
                ...
                .password(branchUserDTO.getPassword())
