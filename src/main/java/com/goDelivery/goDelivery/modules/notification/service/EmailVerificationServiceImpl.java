...
import com.goDelivery.goDelivery.modules.restaurant.service.RestaurantOTPService;
...
public class EmailVerificationServiceImpl implements EmailVerificationService {
    ...
    public void notifyRestaurantSetupComplete(String email, String restaurantName) {
        try {
            ...
            // Mark user as active and verified since we're not doing email verification
            // anymore
            user.setActive(true);
