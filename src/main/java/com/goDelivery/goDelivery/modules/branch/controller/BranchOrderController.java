...
public class BranchOrderController {
    ...
    @PreAuthorize("hasAnyRole('RESTAURANT_ADMIN', 'BRANCH_MANAGER', 'BRANCH_CASHIER')")
    @Operation(summary = "Get branch orders", description = "Get all orders for a specific branch")
    ...
    @PreAuthorize("hasAnyRole('RESTAURANT_ADMIN', 'BRANCH_MANAGER', 'BRANCH_CASHIER')")
    @Operation(summary = "Get pending branch orders", description = "Get all pending orders for a specific branch")
    ...
    @PreAuthorize("hasAnyRole('RESTAURANT_ADMIN', 'BRANCH_MANAGER', 'BRANCH_CASHIER')")
    @Operation(summary = "Accept order", description = "Accept a pending order and start preparation")
    ...
    @PreAuthorize("hasAnyRole('RESTAURANT_ADMIN', 'BRANCH_MANAGER', 'BRANCH_CASHIER')")
    @Operation(summary = "Mark order ready for pickup", description = "Mark an order as ready for pickup or delivery")
    ...
    @PreAuthorize("hasAnyRole('RESTAURANT_ADMIN', 'BRANCH_MANAGER', 'BRANCH_CASHIER')")
    @Operation(summary = "Complete order", description = "Mark an order as completed/delivered")
    ...
    @PreAuthorize("hasAnyRole('RESTAURANT_ADMIN', 'BRANCH_MANAGER', 'BRANCH_CASHIER')")
    @Operation(summary = "Get branch payments", description = "Get all payments for orders from a specific branch")
    ...
    public ResponseEntity<PaymentResponse> processRefund(
        ...
        // PaymentResponse refundResponse = paymentService.processRefund(paymentId,
        // refundReason);
    ...
    @PreAuthorize("hasAnyRole('BRANCH_MANAGER', 'BRANCH_CASHIER')")
    ...
    @PreAuthorize("hasAnyRole('RESTAURANT_ADMIN', 'BRANCH_MANAGER', 'BRANCH_CASHIER')")
    @Operation(summary = "Get branch order statistics", description = "Get order statistics for a specific branch")
