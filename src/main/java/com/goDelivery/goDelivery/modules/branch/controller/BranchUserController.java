...
import com.goDelivery.goDelivery.modules.branch.service.BranchUserService;
...
public class BranchUserController {
    ...
    @Operation(summary = "Get current branch manager's branch", description = "Get the branch information for the currently logged in branch manager")
    ...
    @Operation(summary = "Create branch user", description = "Create a new user for a specific branch")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all branch users", description = "Retrieve all users belonging to a specific branch")
    ...
    @Operation(summary = "Get active branch users", description = "Retrieve all active users belonging to a specific branch")
    ...
    @PutMapping("/{userId}")
    @Operation(summary = "Update branch user", description = "Update details of a branch user")
    ...
    @Operation(summary = "Toggle branch user status", description = "Enable or disable a branch user")
    ...
    @Operation(summary = "Register a new branch manager", description = "Public endpoint to register a new branch manager")
