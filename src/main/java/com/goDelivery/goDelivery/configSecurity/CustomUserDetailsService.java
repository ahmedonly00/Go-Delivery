...
//             return createUserDetails(user.getEmail(), user.getPassword(), user.getRole(), user.isActive());
//         }
...
//             return createUserDetails(admin.getEmail(), admin.getPassword(), admin.getRole(), true);
//         }

//         throw new UsernameNotFoundException("User not found with email: " + username);
//     }

//     private UserDetails createUserDetails(String email, String password, Enum<?> role, boolean isActive) {
//         return User.builder()
//                 .username(email)
//                 .password(password)
...
//         System.out.println("Creating authority with role: " + roleName);
